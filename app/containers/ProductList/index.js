          ...
          <Card style={[appStyles.addBox, { height: "auto" }, styles.orderBox]}>
            <View style={{ paddingLeft: 10, paddingTop: 10 }}>
              <View style={styles.orderInfo}>
                ...
                <Text style={styles.Qty}>{orderdetail.itemCount} Items</Text>
                <Text style={styles.dateTime}>
                  {moment(orderdetail.orderDate).format("DD MMM YYYY")}
                </Text>
                <Text style={styles.dateTime}>
                  {moment(orderdetail.orderDate).format("LT")}
                </Text>
              </View>
              <View
                style={{
                  merginRight: Layout.indent,
            ...
            >
              <Text
                style={{ fontSize: 14, color: "#00545F", fontWeight: "bold" }}
              >
                (To return, press checkbox after putting quantity)
              </Text>
            </Card>
                  ...
                  >
                    <ListItem icon style={styles.ListItems} noBorder>
                      ...
                      <Body style={styles.bodyText}>
                        ...
                        >
                          {orderitems.itemName} {orderitems.quantity}x{" "}
                        </Text>
                      </Body>
                      {orderitems.itemStatus == "PICKED" ? (
                        ...
                        <Right style={styles.ListRight}>
                          ...
                          <CheckBox
                            ...
                            isChecked={
                              this.state.qty.indexOf(orderitems.id) !== -1
                            }
                          />
                        </Right>
                      )}
